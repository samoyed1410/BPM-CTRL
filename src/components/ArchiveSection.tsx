...
const archiveItems = [
  {
    type: "video",
    title: "FREQUENCY 000 — Recap",
    description: "The genesis transmission. Relive the origin.",
    icon: Play,
    link: "#",
  },
  {
    ...
    description: "Visual signals from the underground.",
    icon: Image,
    link: "#",
  },
  {
    ...
    description: "Social transmissions from the collective.",
    icon: ExternalLink,
    link: "#",
  },
];
  ...
  return (
    <section id="archive" className="py-24 px-4 relative">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <span className="text-xs font-display tracking-[0.4em] text-primary uppercase">Decoded Memories</span>
        </motion.div>
        ...
        >
          Open past rave memories. Every signal leaves a trace.
        </motion.p>
