...
echo "  3. Verify site_assets loaded: https://$DOMAIN"
echo "  4. Test admin login:         https://$DOMAIN/admin/login"
echo "  5. Update public_url values in site_assets if storage URLs changed"
echo ""
